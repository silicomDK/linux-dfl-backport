...
qsfp-mem-core-y := drivers/net/phy/qsfp-mem-core.o
qsfp-mem-dfl-y := drivers/net/phy/qsfp-mem-dfl.o
qsfp-mem-platform-y := drivers/net/phy/qsfp-mem-platform.o
